...
impl EntityReference for crate::WritePolicy {
...
#[derive(Debug)]
pub struct WritePolicyRequest<R = crate::WritePolicy> {
    query: SelectQuery,
...
impl<R> Clone for WritePolicyRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> WritePolicyRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("WritePolicy")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> WritePolicyRequest<T> {
        WritePolicyRequest {
            query: self.query,
...
impl<R: teaql_core::Entity> crate::PurposedQuery<WritePolicyRequest<R>> {
    pub fn comment(mut self, comment: impl Into<String>) -> Self {
