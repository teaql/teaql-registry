...
impl<R> AssetRequest<R> {
    ...
    fn dynamic_json_self_field(field: &str) -> Option<&'static str> {
        match field {
            ...
            "component" | "component_id" => Some("component_id"),
    ...
    pub fn select_all(self) -> Self {
        ...
        request = request.select_component();
    ...
    pub fn filter_by_component(mut self, value: impl EntityReference) -> Self {
        self.query = self.query.and_filter(Expr::eq("component_id", value.entity_id_value()));
        self
    }

    pub fn with_component_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.and_filter(Expr::in_subquery(
            "component_id",
        ...
        self.relation_filters.push(RelationFilter::new("component", selection));
        self
    }


    pub fn without_component_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.and_filter(Expr::not_in_subquery(
            "component_id",
            <crate::Component as teaql_core::TeaqlEntity>::entity_descriptor(),
    ...
    pub fn have_component(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("component_id"));
        self
    }

    pub fn have_no_component(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("component_id"));
        self
    }


    pub fn group_by_component(self) -> Self {
        self.group_by("component_id")
    }

    pub fn group_by_component_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
    ...
    pub fn group_by_component_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
    ...
    pub fn group_by_component_with(mut self, request: impl Into<QuerySelection>) -> Self {
        self.query = self.query.group_by("component_id");
        self.query_options.object_group_bys.push(ObjectGroupBy::new(
            "component",
            "component_id",
            request,
    ...
    pub fn group_by_component_with_details(self) -> Self {
        self.group_by_component_with_details_from(crate::Q::components().unlimited())
    }

    pub fn group_by_component_with_details_from(self, request: impl Into<QuerySelection>) -> Self {
        self.group_by_component_with(request)
    }


    pub fn roll_up_to_component(self) -> Self {
        self.roll_up_to_component_with(crate::Q::components().unlimited())
    }

    pub fn roll_up_to_component_with(self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.with_component_matching(selection.clone())
            .group_by_component_with(selection)
    }

    pub fn count_component(self) -> Self {
        self.count_component_as("component_count")
    }

    pub fn count_component_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("component_id", alias)
    }

    pub fn unselect_component(mut self) -> Self {
        self.query.projection.retain(|field| field != "component_id");
        self.query.relations.retain(|relation| relation.name != "component");
        self
    }
    ...
    pub fn select_component(mut self) -> Self {
        self.query = self.query.relation("component");
        self
    }

    pub fn select_component_with(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.relation_query("component", selection.clone().into_query());
        self.relation_selections.push(RelationSelection::new("component", selection));
        self
}

    pub fn facet_by_component_as(self, facet_name: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.facet_by_component_as_with_options(facet_name, request, true)
    }

    pub fn facet_by_component_as_with_options(
        mut self,
        facet_name: impl Into<String>,
        request: impl Into<QuerySelection>,
        include_all_facets: bool,
