...
impl<'a> AssetExpression<'a> {
    ...
    pub fn get_component_id(self) -> crate::ValueExpression<'a, u64> {
    ...
    pub fn get_component(self) -> crate::ComponentExpression<'a> {
        let next = self.result.and_then("component", |entity| entity.eval_component());
