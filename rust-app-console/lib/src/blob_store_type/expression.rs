#[derive(Clone)]
pub struct BlobStoreTypeExpression<'a> {
...
impl<'a> BlobStoreTypeExpression<'a> {
    ...
    fn resolve(&self) -> Option<&'a crate::BlobStoreType> {
        match &self.result {
    ...
    pub fn eval(&self) -> Option<&'a crate::BlobStoreType> {
        self.resolve()
    }
...
#[derive(Clone)]
pub struct BlobStoreTypeListExpression<'a> {
...
impl<'a> BlobStoreTypeListExpression<'a> {
    ...
    fn resolve(&self) -> Option<&'a teaql_core::SmartList<crate::BlobStoreType>> {
        match &self.result {
            teaql_core::eval::EvalResult::Value(v) => Some(*v),
            teaql_core::eval::EvalResult::Null => None,
            teaql_core::eval::EvalResult::NotLoaded { failed_node, attempted_path } => {
    ...
    pub fn eval(&self) -> Option<&'a teaql_core::SmartList<crate::BlobStoreType>> {
        self.resolve()
    }
    ...
    pub fn first(&self) -> crate::BlobStoreTypeExpression<'a> {
    ...
    pub fn get(&self, index: usize) -> crate::BlobStoreTypeExpression<'a> {
