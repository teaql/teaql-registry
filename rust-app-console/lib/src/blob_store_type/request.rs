...
impl EntityReference for crate::BlobStoreType {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/blob_store_type
#[derive(Debug)]
pub struct BlobStoreTypeRequest<R = crate::BlobStoreType> {
    query: SelectQuery,
...
impl<R> Clone for BlobStoreTypeRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> BlobStoreTypeRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("BlobStoreType")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> BlobStoreTypeRequest<T> {
        BlobStoreTypeRequest {
            query: self.query,
...
impl<R> Default for BlobStoreTypeRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<R: teaql_core::Entity> crate::PurposedQuery<BlobStoreTypeRequest<R>> {
    pub fn comment(mut self, comment: impl Into<String>) -> Self {
