...
impl EntityReference for crate::UserStatus {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/user_status
#[derive(Debug)]
pub struct UserStatusRequest<R = crate::UserStatus> {
    query: SelectQuery,
...
impl<R> Clone for UserStatusRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> UserStatusRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("UserStatus")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> UserStatusRequest<T> {
        UserStatusRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<TeaqlEntityStream<'a, R, TeaqlDataServiceError<C::UserStatusRepository<'a>>>, TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for UserStatus is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn name_is_disabled(self) -> Self {
        self.with_name_is("Disabled")
    }

    pub fn with_name_is_disabled(self) -> Self {
        self.with_name_is("Disabled")
    }



    pub fn with_name_is_not_disabled(self) -> Self {
        self.with_name_is_not("Disabled")
    }


    pub fn name_is_locked(self) -> Self {
        self.with_name_is("Locked")
    }

    pub fn with_name_is_locked(self) -> Self {
        self.with_name_is("Locked")
    }



    pub fn with_name_is_not_locked(self) -> Self {
        self.with_name_is_not("Locked")
    }
    ...
    pub fn code_is_disable_d(self) -> Self {
        self.with_code_is("DISABLED")
    }

    pub fn with_code_is_disable_d(self) -> Self {
        self.with_code_is("DISABLED")
    }



    pub fn with_code_is_not_disable_d(self) -> Self {
        self.with_code_is_not("DISABLED")
    }


    pub fn code_is_locke_d(self) -> Self {
        self.with_code_is("LOCKED")
    }

    pub fn with_code_is_locke_d(self) -> Self {
        self.with_code_is("LOCKED")
    }



    pub fn with_code_is_not_locke_d(self) -> Self {
        self.with_code_is_not("LOCKED")
    }
...
impl<R> Default for UserStatusRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< UserStatusRequest<R> > for SelectQuery {
    fn from(request: UserStatusRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< UserStatusRequest<R> > for QuerySelection {
    fn from(request: UserStatusRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::UserStatus> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::UserStatusRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<UserStatusRequest<R>> {
    pub fn comment(mut self, comment: impl Into<String>) -> Self {
        self.inner.query_options.comment = Some(comment.into());
        self
    }

    pub fn new_entity<C>(&self, ctx: &C) -> crate::UserStatus
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        let mut entity = crate::UserStatus::runtime_new(ctx.user_context().entity_root());
        if let Ok(id) = ctx.user_context().next_id(crate::UserStatus::ENTITY_NAME) {
            entity.update_id(id);
        }
        entity
    }

    fn into_inner_with_trace(mut self) -> UserStatusRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<crate::request_support::TeaqlEntityStream<'a, R, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity + 'a,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::UserStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
