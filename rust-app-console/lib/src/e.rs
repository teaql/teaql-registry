...
impl E {
    ...
    pub fn write_policy<'a>(value: &'a crate::WritePolicy) -> crate::WritePolicyExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("WritePolicy(id={})", value.id()));
    ...
    pub fn user_status<'a>(value: &'a crate::UserStatus) -> crate::UserStatusExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("UserStatus(id={})", value.id()));
    ...
    pub fn component<'a>(value: &'a crate::Component) -> crate::ComponentExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("Component(id={})", value.id()));
        crate::ComponentExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }

    pub fn asset_blob<'a>(value: &'a crate::AssetBlob) -> crate::AssetBlobExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("AssetBlob(id={})", value.id()));
        crate::AssetBlobExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }
    ...
    pub fn security_user<'a>(value: &'a crate::SecurityUser) -> crate::SecurityUserExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("SecurityUser(id={})", value.id()));
        crate::SecurityUserExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }

    pub fn security_role<'a>(value: &'a crate::SecurityRole) -> crate::SecurityRoleExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("SecurityRole(id={})", value.id()));
