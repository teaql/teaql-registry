...
impl EntityReference for crate::SecurityRole {
...
#[derive(Debug)]
pub struct SecurityRoleRequest<R = crate::SecurityRole> {
    query: SelectQuery,
...
impl<R> Clone for SecurityRoleRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> SecurityRoleRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("SecurityRole")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> SecurityRoleRequest<T> {
        SecurityRoleRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
        let repository = ctx
            .security_role_repository()
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<TeaqlEntityStream<'a, R, TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>, TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for SecurityRole is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn select_role_id(mut self) -> Self {
        self.query = self.query.project("role_id");
        self
    }

    pub fn project_role_id(self) -> Self {
        self.select_role_id()
    }

    pub fn select_role_id_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_role_id_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_role_id_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("role_id", raw_sql_segment));
        self
    }

    pub fn group_by_role_id(self) -> Self {
        self.group_by("role_id")
    }

    pub fn group_by_role_id_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
    ...
    pub fn group_by_role_id_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
    ...
    pub fn count_role_id(self) -> Self {
        self.count_role_id_as("role_id_count")
    }

    pub fn count_role_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("role_id", alias)
    }

    pub fn sum_role_id(self) -> Self {
        self.sum_role_id_as("sum_role_id")
    }

    pub fn sum_role_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("role_id", alias)
    }

    pub fn avg_role_id(self) -> Self {
        self.avg_role_id_as("avg_role_id")
    }

    pub fn avg_role_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("role_id", alias)
    }

    pub fn min_role_id(self) -> Self {
        self.min_role_id_as("min_role_id")
    }

    pub fn min_role_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("role_id", alias)
    }

    pub fn max_role_id(self) -> Self {
        self.max_role_id_as("max_role_id")
    }

    pub fn max_role_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("role_id", alias)
    }

    pub fn unselect_role_id(mut self) -> Self {
        self.query.projection.retain(|field| field != "role_id");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "role_id");
        self
    }
    ...
    pub fn create_role_id_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_role_id_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("role_id", value));
        self
    }



    pub fn with_role_id_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("role_id", value));
        self
    }

    pub fn with_role_id_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("role_id", value));
        self
    }

    pub fn with_role_id_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("role_id", value));
        self
    }

    pub fn with_role_id_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("role_id", value));
        self
    }

    pub fn with_role_id_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("role_id", value));
        self
    }

    pub fn with_role_id_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("role_id", lower, upper));
        self
    }

    pub fn with_role_id_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
    ...
    pub fn with_role_id_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("role_id", value));
        self
    }

    pub fn with_role_id_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("role_id", value));
        self
    }

    pub fn with_role_id_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("role_id", value));
        self
    }

    pub fn with_role_id_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("role_id", value));
        self
    }

    pub fn with_role_id_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("role_id", value));
        self
    }

    pub fn with_role_id_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("role_id", value));
        self
    }

    pub fn with_role_id_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("role_id", value));
        self
    }
    pub fn with_role_id_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("role_id", value));
        self
    }

    pub fn with_role_id_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("role_id", value));
        self
    }

    pub fn with_role_id_is_unknown(mut self) -> Self {
    ...
    pub fn with_role_id_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("role_id"));
        self
    }


    pub fn order_by_role_id_asc(mut self) -> Self {
        self.query = self.query.order_asc("role_id");
        self
    }

    pub fn order_by_role_id_desc(mut self) -> Self {
        self.query = self.query.order_desc("role_id");
        self
    }

    pub fn order_by_role_id_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("role_id");
        self
    }

    pub fn order_by_role_id_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("role_id");
        self
    }
...
impl<R> Default for SecurityRoleRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< SecurityRoleRequest<R> > for SelectQuery {
    fn from(request: SecurityRoleRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< SecurityRoleRequest<R> > for QuerySelection {
    fn from(request: SecurityRoleRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::SecurityRole> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<SecurityRoleRequest<R>> {
    pub fn comment(mut self, comment: impl Into<String>) -> Self {
        self.inner.query_options.comment = Some(comment.into());
        self
    }

    pub fn new_entity<C>(&self, ctx: &C) -> crate::SecurityRole
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        let mut entity = crate::SecurityRole::runtime_new(ctx.user_context().entity_root());
        if let Ok(id) = ctx.user_context().next_id(crate::SecurityRole::ENTITY_NAME) {
            entity.update_id(id);
        }
        entity
    }

    fn into_inner_with_trace(mut self) -> SecurityRoleRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<crate::request_support::TeaqlEntityStream<'a, R, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity + 'a,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::SecurityRoleRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
