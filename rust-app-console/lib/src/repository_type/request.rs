...
impl EntityReference for crate::RepositoryType {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/repository_type
#[derive(Debug)]
pub struct RepositoryTypeRequest<R = crate::RepositoryType> {
    query: SelectQuery,
...
impl<R> Clone for RepositoryTypeRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> RepositoryTypeRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("RepositoryType")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> RepositoryTypeRequest<T> {
        RepositoryTypeRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<TeaqlEntityStream<'a, R, TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>, TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for RepositoryType is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn name_is_hosted(self) -> Self {
        self.with_name_is("Hosted")
    }

    pub fn with_name_is_hosted(self) -> Self {
        self.with_name_is("Hosted")
    }



    pub fn with_name_is_not_hosted(self) -> Self {
        self.with_name_is_not("Hosted")
    }


    pub fn name_is_proxy(self) -> Self {
        self.with_name_is("Proxy")
    }

    pub fn with_name_is_proxy(self) -> Self {
        self.with_name_is("Proxy")
    }



    pub fn with_name_is_not_proxy(self) -> Self {
        self.with_name_is_not("Proxy")
    }
    ...
    pub fn code_is_hoste_d(self) -> Self {
        self.with_code_is("HOSTED")
    }

    pub fn with_code_is_hoste_d(self) -> Self {
        self.with_code_is("HOSTED")
    }



    pub fn with_code_is_not_hoste_d(self) -> Self {
        self.with_code_is_not("HOSTED")
    }


    pub fn code_is_prox_y(self) -> Self {
        self.with_code_is("PROXY")
    }

    pub fn with_code_is_prox_y(self) -> Self {
        self.with_code_is("PROXY")
    }



    pub fn with_code_is_not_prox_y(self) -> Self {
        self.with_code_is_not("PROXY")
    }
    ...
    pub fn display_order_is_number(self) -> Self {
...
impl<R> Default for RepositoryTypeRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< RepositoryTypeRequest<R> > for SelectQuery {
    fn from(request: RepositoryTypeRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< RepositoryTypeRequest<R> > for QuerySelection {
    fn from(request: RepositoryTypeRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::RepositoryType> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<RepositoryTypeRequest<R>> {
    pub fn comment(mut self, comment: impl Into<String>) -> Self {
        self.inner.query_options.comment = Some(comment.into());
        self
    }

    pub fn new_entity<C>(&self, ctx: &C) -> crate::RepositoryType
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        let mut entity = crate::RepositoryType::runtime_new(ctx.user_context().entity_root());
        if let Ok(id) = ctx.user_context().next_id(crate::RepositoryType::ENTITY_NAME) {
            entity.update_id(id);
        }
        entity
    }

    fn into_inner_with_trace(mut self) -> RepositoryTypeRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<crate::request_support::TeaqlEntityStream<'a, R, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity + 'a,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::RepositoryTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
