...
pub trait TeaqlRepositoryProvider: TeaqlRuntime {
    ...
    type RepositoryTypeRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;
    ...
    fn write_policy_repository(&self) -> Result<Self::WritePolicyRepository<'_>, ContextError>;
    type BlobStoreTypeRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;
    ...
    fn user_status_repository(&self) -> Result<Self::UserStatusRepository<'_>, ContextError>;
    type BlobStoreConfigurationRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;
    ...
    fn component_repository(&self) -> Result<Self::ComponentRepository<'_>, ContextError>;
    type AssetBlobRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn asset_blob_repository(&self) -> Result<Self::AssetBlobRepository<'_>, ContextError>;
    type AssetRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn asset_repository(&self) -> Result<Self::AssetRepository<'_>, ContextError>;
    type SecurityUserRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn security_user_repository(&self) -> Result<Self::SecurityUserRepository<'_>, ContextError>;
    type SecurityRoleRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn security_role_repository(&self) -> Result<Self::SecurityRoleRepository<'_>, ContextError>;
    type SecurityPrivilegeRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;
