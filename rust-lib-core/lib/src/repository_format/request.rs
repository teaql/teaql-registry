...
impl EntityReference for crate::RepositoryFormat {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/repository_format
#[derive(Debug)]
pub struct RepositoryFormatRequest<R = crate::RepositoryFormat> {
    query: SelectQuery,
...
impl<R> Clone for RepositoryFormatRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> RepositoryFormatRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("RepositoryFormat")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> RepositoryFormatRequest<T> {
        RepositoryFormatRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
        let repository = ctx
            .repository_format_repository()
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<TeaqlEntityStream<'a, R, TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>, TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for RepositoryFormat is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn id_is_value_1008(self) -> Self {
        self.with_id_is("1008")
    }

    pub fn with_id_is_value_1008(self) -> Self {
        self.with_id_is("1008")
    }



    pub fn with_id_is_not_value_1008(self) -> Self {
        self.with_id_is_not("1008")
    }



    pub fn name_is_maven2(self) -> Self {
    ...
    pub fn with_name_is_not_maven2(self) -> Self {
        self.with_name_is_not("Maven2")
    }


    pub fn name_is_raw(self) -> Self {
        self.with_name_is("Raw")
    }

    pub fn with_name_is_raw(self) -> Self {
        self.with_name_is("Raw")
    }



    pub fn with_name_is_not_raw(self) -> Self {
        self.with_name_is_not("Raw")
    }


    pub fn name_is_docker(self) -> Self {
        self.with_name_is("Docker")
    }

    pub fn with_name_is_docker(self) -> Self {
        self.with_name_is("Docker")
    }



    pub fn with_name_is_not_docker(self) -> Self {
        self.with_name_is_not("Docker")
    }


    pub fn name_is_npm(self) -> Self {
        self.with_name_is("npm")
    }

    pub fn with_name_is_npm(self) -> Self {
        self.with_name_is("npm")
    }



    pub fn with_name_is_not_npm(self) -> Self {
        self.with_name_is_not("npm")
    }


    pub fn name_is_py_p_i(self) -> Self {
        self.with_name_is("PyPI")
    }

    pub fn with_name_is_py_p_i(self) -> Self {
        self.with_name_is("PyPI")
    }



    pub fn with_name_is_not_py_p_i(self) -> Self {
        self.with_name_is_not("PyPI")
    }


    pub fn name_is_go_modules(self) -> Self {
        self.with_name_is("Go Modules")
    }

    pub fn with_name_is_go_modules(self) -> Self {
        self.with_name_is("Go Modules")
    }



    pub fn with_name_is_not_go_modules(self) -> Self {
        self.with_name_is_not("Go Modules")
    }


    pub fn name_is_cargo(self) -> Self {
        self.with_name_is("Cargo")
    }

    pub fn with_name_is_cargo(self) -> Self {
        self.with_name_is("Cargo")
    }



    pub fn with_name_is_not_cargo(self) -> Self {
        self.with_name_is_not("Cargo")
    }


    pub fn name_is_nu_get(self) -> Self {
        self.with_name_is("NuGet")
    }

    pub fn with_name_is_nu_get(self) -> Self {
        self.with_name_is("NuGet")
    }



    pub fn with_name_is_not_nu_get(self) -> Self {
        self.with_name_is_not("NuGet")
    }



    pub fn code_is_maven2(self) -> Self {
    ...
    pub fn with_code_is_not_maven2(self) -> Self {
        self.with_code_is_not("MAVEN2")
    }


    pub fn code_is_ra_w(self) -> Self {
        self.with_code_is("RAW")
    }

    pub fn with_code_is_ra_w(self) -> Self {
        self.with_code_is("RAW")
    }



    pub fn with_code_is_not_ra_w(self) -> Self {
        self.with_code_is_not("RAW")
    }


    pub fn code_is_docke_r(self) -> Self {
        self.with_code_is("DOCKER")
    }

    pub fn with_code_is_docke_r(self) -> Self {
        self.with_code_is("DOCKER")
    }



    pub fn with_code_is_not_docke_r(self) -> Self {
        self.with_code_is_not("DOCKER")
    }


    pub fn code_is_np_m(self) -> Self {
        self.with_code_is("NPM")
    }

    pub fn with_code_is_np_m(self) -> Self {
        self.with_code_is("NPM")
    }



    pub fn with_code_is_not_np_m(self) -> Self {
        self.with_code_is_not("NPM")
    }


    pub fn code_is_pyp_i(self) -> Self {
        self.with_code_is("PYPI")
    }

    pub fn with_code_is_pyp_i(self) -> Self {
        self.with_code_is("PYPI")
    }



    pub fn with_code_is_not_pyp_i(self) -> Self {
        self.with_code_is_not("PYPI")
    }


    pub fn code_is_gomo_d(self) -> Self {
        self.with_code_is("GOMOD")
    }

    pub fn with_code_is_gomo_d(self) -> Self {
        self.with_code_is("GOMOD")
    }



    pub fn with_code_is_not_gomo_d(self) -> Self {
        self.with_code_is_not("GOMOD")
    }


    pub fn code_is_carg_o(self) -> Self {
        self.with_code_is("CARGO")
    }

    pub fn with_code_is_carg_o(self) -> Self {
        self.with_code_is("CARGO")
    }



    pub fn with_code_is_not_carg_o(self) -> Self {
        self.with_code_is_not("CARGO")
    }


    pub fn code_is_nuge_t(self) -> Self {
        self.with_code_is("NUGET")
    }

    pub fn with_code_is_nuge_t(self) -> Self {
        self.with_code_is("NUGET")
    }
...
impl<R> Default for RepositoryFormatRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< RepositoryFormatRequest<R> > for SelectQuery {
    fn from(request: RepositoryFormatRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< RepositoryFormatRequest<R> > for QuerySelection {
    fn from(request: RepositoryFormatRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::RepositoryFormat> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<RepositoryFormatRequest<R>> {
    pub fn comment(mut self, comment: impl Into<String>) -> Self {
        self.inner.query_options.comment = Some(comment.into());
        self
    }

    pub fn new_entity<C>(&self, ctx: &C) -> crate::RepositoryFormat
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        let mut entity = crate::RepositoryFormat::runtime_new(ctx.user_context().entity_root());
        if let Ok(id) = ctx.user_context().next_id(crate::RepositoryFormat::ENTITY_NAME) {
            entity.update_id(id);
        }
        entity
    }

    fn into_inner_with_trace(mut self) -> RepositoryFormatRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<crate::request_support::TeaqlEntityStream<'a, R, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity + 'a,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::RepositoryFormatRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
