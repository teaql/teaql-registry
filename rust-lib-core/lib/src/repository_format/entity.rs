...
#[teaql(entity = "RepositoryFormat", table = "repository_format_data", data_service = "postgres")]
...
#[teaql(relation(target = "RepositoryConfiguration", local_key = "id", foreign_key = "repository_format_id", many))]
...
impl RepositoryFormat {
    pub const ENTITY_NAME: &'static str = "Repository Format";
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("RepositoryFormat", self.id)
    }
