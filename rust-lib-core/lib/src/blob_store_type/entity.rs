...
#[teaql(entity = "BlobStoreType", table = "blob_store_type_data", data_service = "postgres")]
...
#[teaql(relation(target = "BlobStoreConfiguration", local_key = "id", foreign_key = "blob_store_type_id", many))]
...
impl BlobStoreType {
    pub const ENTITY_NAME: &'static str = "Blob Store Type";
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("BlobStoreType", self.id)
    }
    ...
    pub fn eval_blob_store_configuration_list(&self) -> teaql_core::eval::EvalResult<&SmartList<crate::BlobStoreConfiguration>> {
        if !self.is_loaded("blob_store_configuration_list") {
            ...
            teaql_core::eval::EvalResult::Value(&self.blob_store_configuration_list)
        }
    }
