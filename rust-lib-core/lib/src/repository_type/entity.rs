...
#[teaql(entity = "RepositoryType", table = "repository_type_data", data_service = "postgres")]
...
#[teaql(relation(target = "RepositoryConfiguration", local_key = "id", foreign_key = "repository_type_id", many))]
...
impl RepositoryType {
    pub const ENTITY_NAME: &'static str = "Repository Type";
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("RepositoryType", self.id)
    }
