...
impl<R> ComponentRequest<R> {
    ...
    pub fn project_version_name(self) -> Self {
        self.select_version_name()
    }

    pub fn select_version_name_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_version_name_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_version_name_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("version_name", raw_sql_segment));
        self
    }

    pub fn group_by_version_name(self) -> Self {
        self.group_by("version_name")
    }

    pub fn group_by_version_name_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("version_name");
        request.query = request
            .query
            .project_expr(alias, Expr::column("version_name"));
        request
    }

    pub fn group_by_version_name_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("version_name")
            .aggregate_with_function("version_name", alias, function)
    }

    pub fn count_version_name(self) -> Self {
        self.count_version_name_as("version_name_count")
    }

    pub fn count_version_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("version_name", alias)
    }

    pub fn sum_version_name(self) -> Self {
        self.sum_version_name_as("sum_version_name")
    }

    pub fn sum_version_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("version_name", alias)
    }

    pub fn avg_version_name(self) -> Self {
        self.avg_version_name_as("avg_version_name")
    }

    pub fn avg_version_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("version_name", alias)
    }

    pub fn min_version_name(self) -> Self {
        self.min_version_name_as("min_version_name")
    }

    pub fn min_version_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("version_name", alias)
    }

    pub fn max_version_name(self) -> Self {
        self.max_version_name_as("max_version_name")
    }

    pub fn max_version_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("version_name", alias)
    }
    ...
    pub fn create_version_name_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_version_name_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("version_name", value));
        self
    }
    ...
    pub fn with_version_name_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("version_name", value));
        self
    }
    ...
    pub fn with_version_name_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("version_name", value));
        self
    }
    ...
    pub fn with_version_name_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
    ...
    pub fn with_version_name_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_version_name_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_version_name_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("version_name", value));
        self
    }
    ...
    pub fn with_version_name_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("version_name", value));
        self
    }
    ...
    pub fn with_version_name_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("version_name", value));
        self
    }

    pub fn with_version_name_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("version_name"));
        self
    }
    ...
    pub fn order_by_version_name_desc(mut self) -> Self {
        self.query = self.query.order_desc("version_name");
        self
    }

    pub fn order_by_version_name_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("version_name");
        self
    }

    pub fn order_by_version_name_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("version_name");
        self
    }
