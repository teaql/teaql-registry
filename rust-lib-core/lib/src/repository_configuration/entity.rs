...
impl RepositoryConfiguration {
    ...
    pub fn update_repository_format_to_docker(&mut self) -> &mut Self {
        self.update_repository_format_id(1003_u64)
    }

    pub fn repository_format_is_docker(&self) -> bool {
        self.repository_format_id() == 1003_u64
    }
    pub fn update_repository_format_to_npm(&mut self) -> &mut Self {
        self.update_repository_format_id(1004_u64)
    }

    pub fn repository_format_is_npm(&self) -> bool {
        self.repository_format_id() == 1004_u64
    }
    pub fn update_repository_format_to_pypi(&mut self) -> &mut Self {
        self.update_repository_format_id(1005_u64)
    }

    pub fn repository_format_is_pypi(&self) -> bool {
        self.repository_format_id() == 1005_u64
    }
    pub fn update_repository_format_to_gomod(&mut self) -> &mut Self {
        self.update_repository_format_id(1006_u64)
    }

    pub fn repository_format_is_gomod(&self) -> bool {
        self.repository_format_id() == 1006_u64
    }
    pub fn update_repository_format_to_cargo(&mut self) -> &mut Self {
        self.update_repository_format_id(1007_u64)
    }

    pub fn repository_format_is_cargo(&self) -> bool {
        self.repository_format_id() == 1007_u64
    }
    pub fn update_repository_format_to_nuget(&mut self) -> &mut Self {
        self.update_repository_format_id(1008_u64)
    }
