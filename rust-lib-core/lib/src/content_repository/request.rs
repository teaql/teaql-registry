...
impl EntityReference for crate::ContentRepository {
...
#[derive(Debug)]
pub struct ContentRepositoryRequest<R = crate::ContentRepository> {
    query: SelectQuery,
...
impl<R> Clone for ContentRepositoryRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> ContentRepositoryRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("ContentRepository")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> ContentRepositoryRequest<T> {
        ContentRepositoryRequest {
            query: self.query,
    ...
    pub fn select_children(self) -> Self {
        ...
        request = request.select_component_list();
    ...
    pub fn project_repository_id(self) -> Self {
        self.select_repository_id()
    }

    pub fn select_repository_id_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_repository_id_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_repository_id_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("repository_id", raw_sql_segment));
        self
    }

    pub fn select_repository_id_with_function(self, function: AggregateFunction) -> Self {
        self.select_repository_id_as_with_function("repository_id", function)
    }

    pub fn select_repository_id_as_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.aggregate_with_function("repository_id", alias, function)
    }

    pub fn group_by_repository_id(self) -> Self {
        self.group_by("repository_id")
    }

    pub fn group_by_repository_id_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("repository_id");
        request.query = request
            .query
            .project_expr(alias, Expr::column("repository_id"));
        request
    }

    pub fn group_by_repository_id_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("repository_id")
            .aggregate_with_function("repository_id", alias, function)
    }

    pub fn count_repository_id(self) -> Self {
        self.count_repository_id_as("repository_id_count")
    }

    pub fn count_repository_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("repository_id", alias)
    }

    pub fn sum_repository_id(self) -> Self {
        self.sum_repository_id_as("sum_repository_id")
    }

    pub fn sum_repository_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("repository_id", alias)
    }

    pub fn avg_repository_id(self) -> Self {
        self.avg_repository_id_as("avg_repository_id")
    }

    pub fn avg_repository_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("repository_id", alias)
    }

    pub fn min_repository_id(self) -> Self {
        self.min_repository_id_as("min_repository_id")
    }

    pub fn min_repository_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("repository_id", alias)
    }

    pub fn max_repository_id(self) -> Self {
        self.max_repository_id_as("max_repository_id")
    }

    pub fn max_repository_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("repository_id", alias)
    }

    pub fn standard_deviation_repository_id(self) -> Self {
        self.standard_deviation_repository_id_as("stdDev_repository_id")
    }

    pub fn standard_deviation_repository_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev("repository_id", alias)
    }
    ...
    pub fn sample_variance_repository_id(self) -> Self {
        self.sample_variance_repository_id_as("varSamp_repository_id")
    }

    pub fn sample_variance_repository_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_samp("repository_id", alias)
    }

    pub fn sample_population_variance_repository_id(self) -> Self {
        self.sample_population_variance_repository_id_as("varPop_repository_id")
    }

    pub fn sample_population_variance_repository_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_pop("repository_id", alias)
    }
    ...
    pub fn create_repository_id_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_repository_id_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("repository_id", value));
        self
    }
    ...
    pub fn with_repository_id_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("repository_id", value));
        self
    }
    ...
    pub fn with_repository_id_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("repository_id", value));
        self
    }
    ...
    pub fn with_repository_id_between(
        mut self,
    ...
    pub fn with_repository_id_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
    ...
    pub fn with_repository_id_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_repository_id_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("repository_id", value));
        self
    }

    pub fn with_repository_id_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("repository_id", value));
        self
    }

    pub fn with_repository_id_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("repository_id"));
        self
    }
    ...
    pub fn order_by_repository_id_desc(mut self) -> Self {
        self.query = self.query.order_desc("repository_id");
        self
    }

    pub fn order_by_repository_id_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("repository_id");
        self
    }

    pub fn order_by_repository_id_desc_using_gbk(mut self) -> Self {
    ...
    pub fn with_component_list_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        ...
        self.query = self.query.and_filter(Expr::in_subquery(
            "id",
            <crate::Component as teaql_core::TeaqlEntity>::entity_descriptor(),
    ...
    pub fn without_component_list_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
    ...
    pub fn select_component_list(mut self) -> Self {
        self.query = self.query.relation("component_list");
        self
    }
    ...
    pub fn count_components_as(self, alias: impl Into<String>) -> Self {
    ...
    pub fn stats_from_components(self, request: impl Into<QuerySelection>) -> Self {
...
impl<R> Default for ContentRepositoryRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<R: teaql_core::Entity> crate::PurposedQuery<ContentRepositoryRequest<R>> {
    pub fn comment(mut self, comment: impl Into<String>) -> Self {
