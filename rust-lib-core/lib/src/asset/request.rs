...
impl EntityReference for crate::Asset {
...
#[derive(Debug)]
pub struct AssetRequest<R = crate::Asset> {
    query: SelectQuery,
...
impl<R> Clone for AssetRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> AssetRequest<R> {
    ...
    pub fn return_type<T>(self) -> AssetRequest<T> {
        AssetRequest {
            query: self.query,
    ...
    fn dynamic_json_self_field(field: &str) -> Option<&'static str> {
        match field {
            ...
            "asset_blob" | "asset_blob_id" => Some("asset_blob_id"),
            _ => None,
        }
    }
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("asset_blob_id");
        self
    }
    ...
    pub fn select_all(self) -> Self {
        ...
        request = request.select_asset_blob();
        request
    }
    ...
    pub fn project_component_id(self) -> Self {
        self.select_component_id()
    }

    pub fn select_component_id_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_component_id_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_component_id_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("component_id", raw_sql_segment));
        self
    }

    pub fn select_component_id_with_function(self, function: AggregateFunction) -> Self {
        self.select_component_id_as_with_function("component_id", function)
    }

    pub fn select_component_id_as_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.aggregate_with_function("component_id", alias, function)
    }

    pub fn group_by_component_id(self) -> Self {
        self.group_by("component_id")
    }

    pub fn group_by_component_id_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("component_id");
        request.query = request
            .query
            .project_expr(alias, Expr::column("component_id"));
        request
    }

    pub fn group_by_component_id_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("component_id")
            .aggregate_with_function("component_id", alias, function)
    }

    pub fn count_component_id(self) -> Self {
        self.count_component_id_as("component_id_count")
    }

    pub fn count_component_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("component_id", alias)
    }

    pub fn sum_component_id(self) -> Self {
        self.sum_component_id_as("sum_component_id")
    }

    pub fn sum_component_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("component_id", alias)
    }

    pub fn avg_component_id(self) -> Self {
        self.avg_component_id_as("avg_component_id")
    }

    pub fn avg_component_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("component_id", alias)
    }

    pub fn min_component_id(self) -> Self {
        self.min_component_id_as("min_component_id")
    }

    pub fn min_component_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("component_id", alias)
    }

    pub fn max_component_id(self) -> Self {
        self.max_component_id_as("max_component_id")
    }

    pub fn max_component_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("component_id", alias)
    }

    pub fn standard_deviation_component_id(self) -> Self {
        self.standard_deviation_component_id_as("stdDev_component_id")
    }

    pub fn standard_deviation_component_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev("component_id", alias)
    }

    pub fn square_root_of_population_standard_deviation_component_id(self) -> Self {
    ...
    pub fn sample_variance_component_id(self) -> Self {
        self.sample_variance_component_id_as("varSamp_component_id")
    }

    pub fn sample_variance_component_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_samp("component_id", alias)
    }

    pub fn sample_population_variance_component_id(self) -> Self {
        self.sample_population_variance_component_id_as("varPop_component_id")
    }

    pub fn sample_population_variance_component_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_pop("component_id", alias)
    }
    ...
    pub fn create_component_id_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_component_id_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("component_id", value));
        self
    }
    ...
    pub fn with_component_id_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("component_id", value));
        self
    }
    ...
    pub fn with_component_id_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("component_id", value));
        self
    }
    ...
    pub fn with_component_id_between(
        mut self,
    ...
    pub fn with_component_id_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
    ...
    pub fn with_component_id_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_component_id_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("component_id", value));
        self
    }

    pub fn with_component_id_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("component_id", value));
        self
    }

    pub fn with_component_id_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("component_id"));
        self
    }
    ...
    pub fn order_by_component_id_desc(mut self) -> Self {
        self.query = self.query.order_desc("component_id");
        self
    }

    pub fn order_by_component_id_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("component_id");
        self
    }

    pub fn order_by_component_id_desc_using_gbk(mut self) -> Self {
    ...
    pub fn with_asset_blob_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.and_filter(Expr::in_subquery(
            "asset_blob_id",
    ...
    pub fn have_no_asset_blob(mut self) -> Self {
    ...
    pub fn group_by_asset_blob_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("asset_blob_id");
        request.query = request
            .query
            .project_expr(alias, Expr::column("asset_blob_id"));
        request
    }

    pub fn group_by_asset_blob_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("asset_blob_id")
            .aggregate_with_function("asset_blob_id", alias, function)
    }

    pub fn group_by_asset_blob_with(mut self, request: impl Into<QuerySelection>) -> Self {
        self.query = self.query.group_by("asset_blob_id");
        self.query_options.object_group_bys.push(ObjectGroupBy::new(
            "asset_blob",
            "asset_blob_id",
            request,
    ...
    pub fn group_by_asset_blob_with_details(self) -> Self {
        self.group_by_asset_blob_with_details_from(crate::Q::asset_blobs().unlimited())
    }

    pub fn group_by_asset_blob_with_details_from(self, request: impl Into<QuerySelection>) -> Self {
    ...
    pub fn roll_up_to_asset_blob_with(self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.with_asset_blob_matching(selection.clone())
            .group_by_asset_blob_with(selection)
    }

    pub fn count_asset_blob(self) -> Self {
        self.count_asset_blob_as("asset_blob_count")
    }

    pub fn count_asset_blob_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("asset_blob_id", alias)
    }
    ...
    pub fn select_asset_blob(mut self) -> Self {
        self.query = self.query.relation("asset_blob");
        self
    }
    ...
    pub fn facet_by_asset_blob_as_with_options(
        mut self,
        facet_name: impl Into<String>,
        request: impl Into<QuerySelection>,
        include_all_facets: bool,
...
impl<R> Default for AssetRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<R: teaql_core::Entity> crate::PurposedQuery<AssetRequest<R>> {
    pub fn comment(mut self, comment: impl Into<String>) -> Self {
