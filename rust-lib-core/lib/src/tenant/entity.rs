...
#[teaql(relation(target = "Platform", local_key = "platform_id", foreign_key = "id"))]
    ...
    pub _relations: Box<TenantReverseRelations>,
    #[teaql(dynamic)]
...
impl Tenant {
    ...
    pub(crate) fn runtime_new(root: teaql_runtime::EntityRoot) -> Self {
        Self {
            ...
            platform_id: 0_u64,
            platform: None,
            _relations: Box::new(TenantReverseRelations::new()),
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("Tenant", self.id)
    }
    ...
    pub fn enabled(&self) -> bool {
        self.changed_enabled().and_then(|value| value.try_bool()).unwrap_or(self.enabled)
    }
    ...
    pub fn update_enabled(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        ...
        self.root.set(self.entity_key(), "enabled", value);
        self
    }

    pub fn changed_enabled(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "enabled")
    }

    pub fn eval_enabled(&self) -> teaql_core::eval::EvalResult<bool> {
        if !self.is_loaded("enabled") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "enabled".to_string(), attempted_path: "enabled".to_string() }
                } else {
...
pub struct TenantReverseRelations {
#[teaql(relation(target = "BlobStoreConfiguration", local_key = "id", foreign_key = "tenant_id", many))]
    blob_store_configuration_list: SmartList<crate::BlobStoreConfiguration>,
#[teaql(relation(target = "RepositoryConfiguration", local_key = "id", foreign_key = "tenant_id", many))]
    repository_configuration_list: SmartList<crate::RepositoryConfiguration>,
#[teaql(relation(target = "SecurityUser", local_key = "id", foreign_key = "tenant_id", many))]
    security_user_list: SmartList<crate::SecurityUser>,
#[teaql(relation(target = "SecurityRole", local_key = "id", foreign_key = "tenant_id", many))]
    security_role_list: SmartList<crate::SecurityRole>,
#[teaql(relation(target = "SecurityPrivilege", local_key = "id", foreign_key = "tenant_id", many))]
    security_privilege_list: SmartList<crate::SecurityPrivilege>,
}

impl TenantReverseRelations {
    pub fn new() -> Self {
        Self {
