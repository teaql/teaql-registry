...
pub fn module() -> teaql_runtime::RuntimeModule {
    teaql_runtime::RuntimeModule::new()
        ...
        .initial_graph(teaql_runtime::GraphNode::new("Platform")
            ...
            .value("platform_version", "3.95.1-01")
            .value("version", 1_i64))
        .initial_graph(teaql_runtime::GraphNode::new("ContentRepository")
            .value("id", 1_u64)
            .value("repository_id", 1_i64)
            .value("format_name", "maven2")
            .value("version", 1_i64))
