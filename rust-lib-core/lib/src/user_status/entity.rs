...
#[teaql(entity = "UserStatus", table = "user_status_data", data_service = "postgres")]
...
#[teaql(relation(target = "SecurityUser", local_key = "id", foreign_key = "user_status_id", many))]
...
impl UserStatus {
    pub const ENTITY_NAME: &'static str = "User Status";
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("UserStatus", self.id)
    }
    ...
    pub fn eval_security_user_list(&self) -> teaql_core::eval::EvalResult<&SmartList<crate::SecurityUser>> {
        if !self.is_loaded("security_user_list") {
            ...
            teaql_core::eval::EvalResult::Value(&self.security_user_list)
        }
    }
